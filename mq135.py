...
class MQ135():
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.BENZENECurve = [2,-0.096910013,-0.282041678]
        self.CO2Curve = [2,0.206690981,-0.169347186]
        self.NH4Curve =[2.301029996,-0.116338565,-0.412100475]
    ...
    def MQPercentage(self):
        ...
        val["BENZENE"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_BENZENE)
