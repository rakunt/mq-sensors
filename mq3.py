...
class MQ3():
    ...
    RL_VALUE                     = 2250     # define the load resistance on the board, in kilo ohms (MQ3 RL 1-8MOhm)
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.ALCCurve = [-0.045757491,-0.22184875,-0.654479455]    # two points are taken from the curve. 
    ...
    def MQPercentage(self):
        ...
        val["GAS_ALC"]  = self.MQGetGasPercentage(read/self.Ro, self.GAS_ALC)
        return val
