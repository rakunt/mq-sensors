...
class MQ4():
    ...
    RL_VALUE                     = 20       # define the load resistance on the board, in kilo ohms (MQ7 RL 10-60kOhm)
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.CH4Curve = [2.301029996,0.258158193,-0.36145404]    # two points are taken from the curve. 
