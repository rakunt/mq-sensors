...
class MQ7():
    ...
    RL_VALUE                     = 5        # define the load resistance on the board, in kilo ohms (MQ7 RL 2-20kOhm)
    ...
    def __init__(self, Ro=10, analogPin=0):
        ...
        self.COCurve = [2.77815125,-0.698970004,-0.74559379]    # two points are taken from the curve. 
